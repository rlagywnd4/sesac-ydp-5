...
// 3. 형제 요소
console.log(tigger.previousElementSibling); //직전요소
console.log(tigger.nextElementSibling); // 직후요소
...
// container.append(p);
div1.appendChild(p); //여러개 추가 안되고 하나만 추가 가능
