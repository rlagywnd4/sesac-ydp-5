...
// map(): 배열 내 모든 원소에 대해 연산한 결과를 모아 "새로운 배열" 반환   => foreach는 실행만 하고 반환X(이부분 좀더 알아볼것)
...
// 1. 글자 수가 3개 초과인 단어만 필터링 //map 사용했더니 true, false로 배열이 만들어짐
const three = words.filter((e) => e.length > 3);
console.log(three);
...
// const result = numberss.reduce((accumulator, currentValue) => {
