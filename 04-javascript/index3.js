...
// 변수 선언 키워드 2. let
let b; // 변수 선언
console.log(b); // undifined: 변수 선언만 하고 값을 할당하지 않았으므로 초기값(undefined) 출력
b = 7; // 변수 할당
...
console.log(`${text} 저는 효중입니다. 저의 성별은 ${gender}입니다!`);
...
// const fruits2 = new Array('orange', 'pineapple', 'grape', 'apple'); 이렇게 선언도 가능하나 사용하지 않음
console.log(fruits);
...
// let avg = (mathScore + engScore) / 2; //여기서 자동형변환이 이루어짐
...
console.log(parseFloat(n3, 10)); // n3 값을 10진수의 실수(float)로 바꾸겠다 => 123
...
// NaN : Not-A-Number(숫자가 아님)(그러나 자료형은 숫자형)
